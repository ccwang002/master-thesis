...
% - More description on how the job is queue
...
%    - faster
%    - citation about the accuracy \cite{engstrom2013:systematic}
%- Plot will change if algorithms are changed
%- Specify the test and normalization done for other DE RNA-SEq pipeline
%    - t-test \cite{rapaport2013:comprehensive}
